...
they are excluded from the totals, but hiding the rows would lose the audit trail.
...
def rolls_report(challan=None, from_date=None, to_date=None, company=None, item=None, limit=500):
	...
	rows = frappe.db.sql(
		...
		select
			...
			it.qty_box, it.weight, it.job_work,
			inw.company_name, inw.party, inw.lot_number, inw.location,
