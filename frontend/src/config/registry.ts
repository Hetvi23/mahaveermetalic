		...
		formSections: [
			{
				...
				fieldnames: ["naming_series", "transaction_date", "branch", "party"],
			},
			{
				id: "so-x",
				title: "Production & control",
				description: "Production % and lock are system-driven.",
				fieldnames: ["production_completed_percent", "order_locked"],
			},
		],
		listColumns: [
